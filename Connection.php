 ...
 */
 ...
 $usuario = "comecaco_web_user";

 $contrasena = "Comeca123**";
...
function QueryColumnsOrder($link,$Table,$Column){
  $numItems = count($Column);
  $i = 0;
  ...
  if ($result = mysqli_query($link, "SELECT " . $StringColumn ." FROM " . $Table . " Order By Id")) {
    $Fields = mysqli_num_fields($result);        
...
function QueryColumnsOrderFirst($link,$Table,$Column){
  $numItems = count($Column);
  $i = 0;
  ...
  if ($result = mysqli_query($link, "SELECT " . $StringColumn ." FROM " . $Table . " Order By Id desc LIMIT 0, 1")) {
    $Fields = mysqli_num_fields($result);        
